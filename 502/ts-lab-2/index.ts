...
const Exercise3 = () => {
  ...
  multiply = function (value1: number, value2: number): number {
  ...
  pushToCollection("false", stringCollection); // compile-time error
  pushToCollection("hi", stringCollection);
  pushToCollection("[]", stringCollection); // compile-time error
